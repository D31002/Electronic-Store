...
public class ElectronicStoreApplication {
	...
	CommandLineRunner run(RoleRepository roleRepository, UserRepository userRepository,
		...
		return args ->{
	        ...
	        Product product14 = new Product(14, "Laptop MSI Ryzen 7", "msir8", "sản phẩm 14", "sản phẩm 14 khá ok", new Date(), new Date(), true, 8, 5000000, 6, "product-3.jpg", category2, brand2);
	        ...
	        Product product17 = new Product(17, "Asus i7 2022", "asi6", "sản phẩm 17", "sản phẩm 17 khá ok", new Date(), new Date(), true, 5, 1000000, 5, "product-5.jpg", category1, brand1);
	        Product product18 = new Product(18, "Nokia Lumia 222", "dtnka1", "sản phẩm 18", "sản phẩm 18 khá ok", new Date(), new Date(), true, 6, 15000000, 3, "product-1.jpg", category1, brand2);
	        Product product19 = new Product(19, "MSI i7 2021", "msii77", "sản phẩm 19", "sản phẩm 19 khá ok", new Date(), new Date(), true, 7, 1760000, 1, "product-2.jpg", category1, brand1);
	        Product product20 = new Product(20, "MSI Ryzen 7", "msir88", "sản phẩm 20", "sản phẩm 20 khá ok", new Date(), new Date(), true, 8, 120000, 6, "product-3.jpg", category2, brand2);
	        Product product21 = new Product(21, "Samsung Galaxy 1280", "nka12800", "sản phẩm 21", "sản phẩm 21 khá ok", new Date(), new Date(), true, 9, 1990000, 4, "product-4.jpg", category1, brand1);
	        Product product22 = new Product(22, "Iphone 14 Pro Maxx", "ip14px1", "sản phẩm 22", "sản phẩm 22 khá ok", new Date(), new Date(), true, 10, 210000, 5, "product-5.jpg", category2, brand2);		
