...
//			order.setDeliverDate(new Date());
			...
			String wrapper = "Ngày đặt :" + order.getOrderTime().toString() + "<br>" + "<div> Danh sách sản phẩm :" + "<br>";
			...
			for(int i =0 ;i< productIds.size();i++) {
				...
				wrapper += "&nbsp;&nbsp;&nbsp;" + (i+1) +". " + product.getName() + "&nbsp;&nbsp;&nbsp;"
						+ "Số lượng :" + quantity + "&nbsp;&nbsp;&nbsp;" 
						+ "Giá : " + (product.getPrice()*quantity) + "<br>";
			}
			
			order.setOrderDetails(orderDetails);
			
			orderService.saveOrder(order);
			wrapper += "</div>" + "Tổng tiền đơn hàng : " + subtotal;
			
			sendEmail(user, wrapper);
	...
	public void sendEmail(User user, String wrapper) {
		String from = "kichhoattktest@gmail.com";
		String to = user.getEmail();
		String subject = "THÔNG TIN ĐƠN ĐẶT";
		String content = "Dear [[name]],<br>"
				+ "<h3>"+wrapper+"</h3>" + "Thank you,<br>" + "Admin";
